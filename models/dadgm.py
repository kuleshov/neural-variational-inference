...
class DADGM(Model):
    ...
    def __init__(
        ...
        self.model = model
        self.n_sample = 5 # adjustable parameter, though 1 works best in practice
    ...
    def create_llik(self):
        ...
        t = log_pa_given_z + log_px_given_z + log_pz - log_qz_given_x - log_qa_given_x
        t = t.reshape([100, n_sam])
